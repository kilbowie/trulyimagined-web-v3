...
- [ ] Verify no extra files (no services/_/_ except openapi.yaml)
...
- [ ] IAM Policy prepared for TI Lambda/App:
  ...
  - [ ] Policy allows S3:GetObject on actors/_, agencies/_, studios/\*
  - [ ] Policy allows S3:PutObject on actors/_, agencies/_, studios/\*
  - [ ] Policy allows S3:DeleteObject on actors/_, agencies/_, studios/\*
